...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'aakashsavaliya16@gmail.com')
_default_email_password = 'gufs cpwi acur hfdq'
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', _default_email_password).replace(' ', '')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', f'SkinCraft <{EMAIL_HOST_USER}>')
EMAIL_TIMEOUT = 20
...
LOGIN_URL = '/login/'
# After login, redirect to homepage by default
LOGIN_REDIRECT_URL = '/'
